...
$onlyIf[$findUser[$message[1]]!=$authorID;{title::x: Greška!}{description:**Ne mozeš mutovati sam/a sebe**}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$findUser[$message[1]]!=;{title::x: Greška!}{description:**Nisi napisao/la koga hoces da mutiras.** \n\`$getServerVar[prefix]mute <@user> <vreme> <razlog>\`}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$message[2]!=;{title::x: Greška!}{description:**Vreme nije napisano.** \n\`$getServerVar[prefix]mute <@user> <vreme> <razlog>\`}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$isNumber[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$message[2];sec;];min;];hour;];days;];weeks;];day;];week;];d;];s;];w;];m;];h;]]==true;{title::x: Greška!}{description:**Netacno napisano vreme.** \n\`$getServerVar[prefix]mute <@user> <vreme> <razlog>\`}{footer:$serverName[]}{color:ff0000}]
$textSplit[$noMentionMessage[];:]
$onlyIf[$rolePosition[$highestRole[$client[id]]]<$rolePosition[$roleID[Muted]];{title::x: Greška!}{description:**Moj role nije iznad rola <@&$roleID[Muted]>!**}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$rolePosition[$highestRole[$client[id]]]<$rolePosition[$highestRole[$findUser[$message[1]]]];{title::x: Greška!}{description:**Moj role nije iznad rola od <@$findUser[$message[1]]>!**}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$roleExists[Muted]==true;{title::x: Greška!}{description:**Muted role ne postoji!**}{footer:$serverName[]}{color:ff0000}]
$onlyIf[$userExists[$findUser[$message[1]]]==true;{title::x: Greška!}{description:**Nisi napisao/la koga hoces da mutiras.** \n\`$getServerVar[prefix]mute <@user> <vreme> <razlog>\`}{footer:$serverName[]}{color:ff0000}]
...
$onlyBotPerms[manageroles;{title::x: Greška!}{description:**Tebam imati __Manage Roles__ permisiju da bih mutovao!**}{footer:$serverName[]}{color:ff0000}]
